...
namespace Content.Shared.Input
{
    ...
    public static class ContentKeyFunctions
    {
        ...
        public static readonly BoundKeyFunction OpenInteractionMenu = "OpenInteractionMenu"; /// RS
        public static readonly BoundKeyFunction OpenLanguageMenu = "OpenLanguageMenu"; // Radiant Sector
