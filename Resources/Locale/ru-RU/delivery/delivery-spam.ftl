...
delivery-spam-2 = Причины выбрать Конфедерацию!
    .desc = Реклама Конфедерации.
    .content =
        ...
        ИХ МИРНЫЕ СОТРУДНИКИ УЯЗВИМЫ К ПУЛЯМ! ПОВЕРЬТЕ, МЫ ПРОВЕРЯЛИ! В ОТЛИЧИЕ ОТ СОТРУДНИКОВ Конфедерации, МИРНЫЕ СОТРУДНИКИ СИНДИКАТА ДОХНУТ ОТ ОДНОЙ ПУЛИ В ЛОБ! А ПУЛИ У НАС ЕСТЬ!
...
delivery-spam-7 = Отправьте подкрепление!
    ...
    .content =
        ...
        { "[head=2]Это официальное уведомление [color=red]Начальника Службы Безопасности[/color] Космической станции 15 Конфедерации.[/head]" }
...
delivery-spam-12 = Присоединяйтесь к нам на первом рейсе!
    ...
    .content =
        ...
        { "[head=3]Исследуйте руины Агатара***, теперь открытые для публики благодаря помощи лучших учёных Конфедерации. Все тайны древней Агатарской цивилизации раскопаны и выставлены для вашего удовольствия![/head]" }
