...
book-text-agrichemkit-manual =
    Спасибо, что выбрали безопасный для любого возраста набор химика от Конфедерации "АгроХимия это весело" — лучшую обучающую игру 2468 года! Приготовьтесь узнать всё о крупнейших инновациях сельского хозяйства с поры, как люди закапывали рыбу вместе с семенами кукурузы.
    Содержание:
    ...
    Но если вы хотите произвести впечатление на судей местной окружной ярмарке, организованной компанией «Конфедерация», вам нужно добавить к аммиаку такое же количество этанола.
    ...
    Нестабильный мутаген абсолютно безопасен при использовании в качестве удобрения, и Конфедерация не несёт ответственности за погибшие посевы, чрезмерные счета за воду, новые разумные растения, задающие экзистенциальные вопросы, а также обвитые флорой руки фермеров, что может случайно произойти при его использовании.
