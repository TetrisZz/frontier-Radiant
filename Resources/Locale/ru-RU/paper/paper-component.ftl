...
paper-language-cannot-write = Вы не понимаете язык этого документа и не можете его изменить.
paper-language-native-unavailable = Вы не знаете родной язык своего вида.
paper-language-common-unavailable = Вы не знаете общегалактический язык.
paper-ui-language-label = Язык: { $language }
paper-ui-language-common = Общегалактический
paper-ui-language-unknown = Неизвестный язык
