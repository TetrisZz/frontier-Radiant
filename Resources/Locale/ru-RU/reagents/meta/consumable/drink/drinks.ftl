...
reagent-name-milk-arcana = молоко арканы
reagent-desc-milk-arcana = Сладковатое розовое молоко, вырабатываемое арканами.
reagent-name-milk-goblin = гоблинское молоко
reagent-desc-milk-goblin = Зеленое молоко, вырабатываемое гоблинами.
