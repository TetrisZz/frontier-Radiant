...
anomaly-vessel-component-upgrade-output = количество очков
...
anomaly-scanner-stability-low = Cостояние аномалии: [color=gold]Распад[/color]
anomaly-scanner-stability-medium = Cостояние аномалии: [color=forestgreen]Стабильное[/color]
anomaly-scanner-stability-high = Cостояние аномалии: [color=crimson]Рост[/color]
anomaly-scanner-stability-unknown = Cостояние аномалии: [color=red]ОШИБКА[/color]
...
anomaly-scanner-particle-transformation = - [color=#6b75fa]Изменяющий тип:[/color] { $type }
...
anomaly-scanner-particle-transformation-unknown = - [color=#6b75fa]Изменяющий тип:[/color] [color=red]ОШИБКА[/color]
