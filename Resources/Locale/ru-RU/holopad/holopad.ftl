...
holopad-window-options = [color=darkgray][font size=10][italic]Пожалуйста, выберите локацию для звонка из списка ниже[/italic][/font][/color]
...
holopad-cargo-mailroom = Снабжение - Почтаm
...
holopad-security-arrivals-checkpoint = СБ - КПП Прибыти
