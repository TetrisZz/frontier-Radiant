...
no-eorg-popup-rule-text = Это включает в себя нападение, уничтожение и нанесение серьезных травм игрокам или имуществу без причины. Помните, что вы играете за персонажа на протяжении всего раунда.
no-eorg-popup-close-button = Ознакомился
