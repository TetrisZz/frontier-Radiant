...
# Radiant Sector
ui-options-jukebox-music = Музыка бумбоксов и музыкальных автоматов
...
ui-options-function-open-interaction-menu = Открыть панель взаимодействий
ui-options-function-open-language-menu = Открыть выбор языка речи
