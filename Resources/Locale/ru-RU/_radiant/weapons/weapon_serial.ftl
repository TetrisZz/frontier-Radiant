weapon-serial-examine = Серийный номер: {$serial}
weapon-serial-wiped = Серийный номер стёрт
weapon-registration-slot-name = Слот для оружия
...
weapon-registration-owner-saved = Владелец изменён: {$owner}
weapon-registration-owner-cleared = Владелец очищен
weapon-registration-stamp = Набить номер и занести в базу
weapon-registration-stamp-success = Номер набит и занесён в базу: {$serial}
weapon-registration-already-stamped = У этого оружия уже есть серийный номер
weapon-registration-serial-not-found = Оружие с таким номером не обнаружено в базе
