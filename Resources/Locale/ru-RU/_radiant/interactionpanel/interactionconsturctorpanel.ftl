...
interaction-constructor-help-text = Подстановки: $user — имя игрока, $target — имя цели. Имена появятся только там, где вы напишете эти переменные.
...
interaction-constructor-skrell = шелег
