...
descriptions-cookie-fortune-dataset-47 = Конфедерация заставляет меня писать эти драные записки для печенек, пожалуйста помогите!
...
descriptions-cookie-fortune-dataset-77 = А вы знали, что более 70% сотрудников Конфедерации исчезают в первые пару лет своего контракта? Теперь знаете!
