...
tts-voice-name-elder_lyons_fl3 = Старейшина Лайон (Fallout 3)
...
tts-voice-name-sheogorath = Шеогорат (Skyrim)
tts-voice-name-kodlakwhitemane = Кодлак Белая Грива (Skyrim)
tts-voice-name-khajiit = Каджит (Skyrim)
tts-voice-name-elenwen = Эленвен (Skyrim)
tts-voice-name-emperor = Тит Мид II (Skyrim)
tts-voice-name-guard = Стражник (Skyrim)
tts-voice-name-hagraven = Ворожея (Skyrim)
tts-voice-name-hermaeus_mora = Хермеус Мора (Skyrim)
tts-voice-name-nord = Норд (Skyrim)
tts-voice-name-ulfric = Ульфрик Буревестник (Skyrim)
tts-voice-name-astrid = Астрид (Skyrim)
tts-voice-name-maven = Мавен Чёрный Вереск (Skyrim)
tts-voice-name-nazir = Назир (Skyrim)
tts-voice-name-female_commander = Женщина командир (Skyrim)
tts-voice-name-lord_harkon = Лорд Харкон (Skyrim)
tts-voice-name-serana = Серана (Skyrim)
...
tts-voice-name-johnny = Джонни Сильверхенд (Cyberpunk)
tts-voice-name-panam = Панам Палмер (Cyberpunk)
tts-voice-name-v_female = Ви (Cyberpunk)
tts-voice-name-judy = Джуди Альварес (Cyberpunk)
tts-voice-name-mitch = Митч Андерсон (Cyberpunk)
tts-voice-name-skippy = Скиппи (Cyberpunk)
tts-voice-name-jackie = Джеки Уэллс (Cyberpunk)
tts-voice-name-maiko = Майко Маэда (Cyberpunk)
tts-voice-name-brendan = Брендан (Cyberpunk)
tts-voice-name-Nancy_hartley = Нэнси Хартли (Cyberpunk)
tts-voice-name-oswald_forrest = Освальд Форрест (Cyberpunk)
tts-voice-name-steve = Стив Санчес (Cyberpunk)
...
tts-voice-name-phineasblack = Финеас Блэк (Hogwarts Legacy)
...
tts-voice-name-sanctuary_house_elf = Домовой эльф (Hogwarts Legacy)
...
tts-voice-name-guard_heavy_weapons_platoon_dow = Команда тяжёлого оружия (Warhammer 40,000: Dawn of War)
