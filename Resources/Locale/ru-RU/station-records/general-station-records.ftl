...
general-station-record-shuttle-field = Шаттл
general-station-record-console-record-shuttle = Шаттл: { $shuttle }
...
general-station-record-console-record-no-shuttle = отсутствует
