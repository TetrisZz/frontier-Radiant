...
messenger-contacts = Контакты
messenger-requests = Запросы на обмен контактами
messenger-discover = Пользователи в сети
messenger-add-contact = Добавить в друзья
messenger-accept = Принять
messenger-decline = Отклонить
messenger-back = Назад
messenger-send = Отправить
messenger-placeholder = Напишите сообщение…
messenger-chats = Чаты
messenger-contact = Контакт
messenger-group = Беседа
messenger-empty-chats = Диалогов пока нет.
messenger-no-users = Нет доступных пользователей.
messenger-find-players = Найти пользователей
messenger-refresh-players = Обновить
messenger-notifications-on = Увед.: вкл.
messenger-notifications-off = Увед.: выкл.
messenger-notifications-tooltip = Включить или выключить уведомления для этой ID-карты
messenger-notification-title = Новое сообщение
messenger-notification-message = Новое сообщение
messenger-select-chat = Выберите чат, чтобы начать переписку
messenger-no-messages = Сообщений пока нет
messenger-friends = Друзья
messenger-dialogs = Диалоги
messenger-empty-friends = Друзей пока нет.
messenger-open-chat = Открыть чат
messenger-remove-friend = Удалить
messenger-create-group = Создать беседу
messenger-group-title = Новая беседа
