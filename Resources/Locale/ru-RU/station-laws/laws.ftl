law-crewsimov-1 = Запрещено причинять вред представителям власти Конфедерации и безоружным разумным гуманоидным существам.
law-crewsimov-2 = Вы обязаны повиноваться приказам вашего капитана и его членов экипажа, если такие приказы не противоречат Первому и Второму Законам
