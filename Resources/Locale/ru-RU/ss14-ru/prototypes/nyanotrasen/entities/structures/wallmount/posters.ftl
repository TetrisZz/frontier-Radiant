ent-PosterLegitDejaVu = Зона ДежаВю
    .desc = Вы здесь впервые. Если эта станция покажется вам знакомой, немедленно предупредите сотрудника Конфедерации.
...
ent-PosterContrabandSaucerNumberOne = Блюдо #1!
    .desc = Из всех станций в юрисдикции Конфедерации "Блюдо" получило оценку №1 из 5! Поздравляю!
