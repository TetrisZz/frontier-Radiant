...
ent-FoodMealAvocadoSushiSlice = { ent-FoodMealAvocadoSushi }
    .desc = { ent-FoodMealAvocadoSushi.desc }
ent-FoodMealCarpSushi = суши с карпом
    .desc = Определенно стоит рискнуть.
ent-FoodMealCarpSushiSlice = { ent-FoodMealCarpSushi }
    .desc = { ent-FoodMealCarpSushi.desc }
ent-FoodMealCuredCarpSushiSlice = суши из свежей рыбы
    .desc = Ещё менее рискованно, но всё равно вкусно. Вы всё ещё не знаете, откуда взялись эти водоросли.
ent-FoodMealGasBadSushiSlice = суши с заправки
    .suffix = испорченные
    .desc = Стоит ли риска?
ent-FoodMealGasSafeSushiSlice = { ent-FoodMealGasBadSushiSlice }
    .suffix = безопасные
    .desc = { ent-FoodMealGasBadSushiSlice.desc }
ent-FoodMealCucumberSandwich = сендвич с огурцом
    .desc = Они снова забыли срезать корку.
...
ent-FoodMealPoachedPears = груши-пашот
    .desc = Самое классное блюдо для банки с вином.