...
ent-DrinkLemonLimeCranberryCan = банка клюквенного сока
    .desc = Хотите вкусненького с клюквой? Его любят администраторы во всем мире. Пейте в умеренных количествах. На праздники ассортимент ограничен!
