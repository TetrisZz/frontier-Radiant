...
ent-ChameleonPDA = { ent-ContractorPDA }
    .suffix = хамелеон
    .desc = { ent-ContractorPDA.desc }
ent-DocPDA = КПК смотрителя мед обслуживания
    .desc = Пахнет дезинфицирующим средством.
ent-PublicAffairsLiaisonPDA = КПК специалиста ПСсО
    .desc = Бумажная работа, бумажная работа, бумажная работа!
ent-WizardPDA = КПК волшебника
    .desc = Ты слышишь доносящийся оттуда тихий шёпот.