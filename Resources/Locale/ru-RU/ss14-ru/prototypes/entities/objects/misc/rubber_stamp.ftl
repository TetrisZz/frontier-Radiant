...
ent-RubberStampPsychologist = печать психолога
    ...
    .suffix = НЕ МАППИТЬ
ent-RubberStampBailiff = печать инспектора
    .desc = Штамп для печати важных документов.
    .suffix = НЕ МАППИТЬ
ent-RubberStampDoc = печать смотрителя мед обслуживания
    .desc = { ent-RubberStampBailiff.desc }
    .suffix = НЕ МАППИТЬ
ent-RubberStampWizard = печать волшебника
    .desc = Волшебная печать хаоса для подачи нехаотичной документации — какая ирония.
    .suffix = НЕ МАППИТЬ