...
ent-ZookeeperIDCard = ID карта зоотехника
    .desc = { ent-IDCardStandard.desc }
ent-NFDetectiveIDCard = ID карта детектива
    .desc = { ent-IDCardStandard.desc }
...
ent-UniversalIDCard = универсальная ID карта
    ...
    .suffix = Админ
ent-DocIDCard = ID карта смотрителя мед обслуживания
    .desc = { ent-IDCardStandard.desc }
ent-PublicAffairsIDCard = ID карта специалиста ПСсО
    .desc = { ent-IDCardStandard.desc } 
ent-YipYipIDCard = ID карта Юп-Юп
    .desc = { ent-IDCardStandard.desc }
ent-ShuttleDeedIDCard = { ent-CaptainIDCard }
    .desc = { ent-IDCardStandard.desc }