...
ent-NTHandyFlag = ручной флажок Конфедерации
    .desc = Слава Конфедерации! Подождите, они реально сделали ручной флажок для корпорации?
ent-SyndieHandyFlag = ручной флажок Синдиката
    .desc = Для настоящих патриотов-бунтарей. Смерть Конфедерации!
