...
ent-BookEngineersHandbook = Справочник инженера
    .desc = Справочник по инженерному делу, подготовленный Конфедерацией.
ent-BookScientistsGuidebook = Справочник учёного
    .desc = Путеводитель по миру науки, подготовленный Конфедерацией.
ent-BookSecurity = Безопасность 101
    .desc = Книга о безопасности на станции, подготовленная Конфедерацией. Книга испачкана кровью. Похоже, что её больше использовали как оружие, чем как учебное пособие.
...
ent-BookSpaceLaw = Корпоративный закон
    .desc = Набор правил Конфедерации для поддержания закона и порядка на своих космических станциях.
