...
ent-TrackingImplant = имплант двб
    .desc = Имплант отслеживающий состояние своего владельца, в случае критического и смертельного ранения оповестит ДВБ
...
ent-MindShieldImplant = имплант "Щит разума"
    .desc = Этот имплант обеспечит лояльность к Конфедерации и предотвратит использование устройств контроля разума.
