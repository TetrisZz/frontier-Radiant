...
ent-WeaponLaserCarbine = лазерный карабин
    .desc = Предпочитается службой безопасности Конфедерации за дешевизну и простоту использования.
    .suffix = Винтовка
...
ent-WeaponPulsePistol = импульсный пистолет
    .desc = Новейший энергетический пистолет, предпочитаемый оперативниками Конфедерации в качестве запасного оружия.
    .suffix = Пистолет
ent-WeaponPulseCarbine = импульсный карабин
    .desc = Высокотехнологичный энергетический карабин, который предпочитают оперативники ОБР Конфедерации.
    .suffix = Винтовка
