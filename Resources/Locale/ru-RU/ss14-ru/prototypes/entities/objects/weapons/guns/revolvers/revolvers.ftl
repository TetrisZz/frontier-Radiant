...
ent-WeaponRevolverMateba = Матеба
    .desc = Современный револьвер, используемый элитным, почти мифическим отрядом быстрого реагирования "Эскадрон Смерти" Конфедерации. Уникальный спусковой механизм и расположение ствола обеспечивают высокую скорострельность при минимальной отдаче. Многие заглядывали в этот ствол — но немногие смогли потом об этом рассказать. Вмещает 6 патронов калибра .45 магнум.
    .suffix = Револьвер
ent-WeaponRevolverMatebaAP = { ent-WeaponRevolverMateba }
    .suffix = Бронебойные
    .desc = { ent-WeaponRevolverMateba.desc }
ent-WeaponRevolverPython = Питон
    .desc = Мощный револьвер двойного действия. Громкий и эффектный, идеально подходит для любого агента, который хочет заявить о себе. Вмещает 6 патронов калибра .45 магнум.
    .suffix = Револьвер
