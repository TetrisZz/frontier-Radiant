...
ent-OffsetCaneNT = трость Конфедерации
    .desc = Стандартная трость Конфедерации, со смещённым центром тяжести и логотипом компании. Любима теми, кто предпочитает более корпоративный вид.
