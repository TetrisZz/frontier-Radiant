...
ent-NFPlushieBotanist = плюшевый ботаник
    .desc = Тебе нужна еда, и она просто не перестанет производить радужную травку.
ent-NFPlushieCmo = плюшевый смотритель мед обслуживания
    .desc = Всего в нескольких шагах отсюда.
ent-NFPlushieConstruction = плюшевый строитель
    .desc = Работа в процессе. Жаль, что всё так закончилось.
ent-PlushieLizardInversed = плюшевый дразил
    .desc = Очаровательная мягкая игрушка, напоминающая человека-ящера из другого измерения. Фу!
ent-PlushieMailVulp = плюшевая вульпа-почтальон
    .desc = Пахнет мятой и напоминает о нераспечатанной почте. Вам стоит проверить свою почту!
ent-NFPlushieSharkMinnow = плюшевая карпоакула
    .desc = Это хотело убить тебя! Это убило твоих друзей! Теперь этот источник посттравматического стрессового расстройства!
ent-PlushieYarrMoth = плюшевый ниан пират
    .desc = Он коварный и одет в лихой плащ. Он дрожит, когда вы его сжимаете!
