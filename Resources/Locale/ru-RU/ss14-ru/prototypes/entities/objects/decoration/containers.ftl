...
ent-ShippingContainerNanotrasen = грузовой контейнер Конфедерации
    .desc = Контейнер стандартного размера для транспортировки больших объёмов грузов. На этом контейнере изображён логотип Конфедерации, и поэтому внутри может быть что угодно.
