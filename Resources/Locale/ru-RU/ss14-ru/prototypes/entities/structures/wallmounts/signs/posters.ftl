...
ent-PosterContrabandMissingGloves = Пропавшие перчатки
    .desc = Этот плакат описывает возмущение, возникшее после того, как Конфедерация сократила финансовые расходы на закупку изолирующих перчаток.
ent-PosterContrabandHackingGuide = Руководство по взлому
    .desc = Этот плакат подробно описывает внутреннюю работу стандартных воздушных шлюзов Конфедерации. К сожалению, он устарел.
ent-PosterContrabandRIPBadger = Спите спокойно, барсуки
    .desc = Этот провокационный плакат рассказывает о геноциде, устроенном Конфедерацией на космической станции, полной барсуков.
...
ent-PosterContrabandPower = Мощь
    .desc = Плакат, который изображает власть за пределами Конфедерации.
...
ent-PosterContrabandRebelsUnite = Бунтари вместе
    .desc = Плакат, призывающий читателя восстать против Конфедерации.
...
ent-PosterLegitNanotrasenLogo = Логотип Конфедерации
    .desc = Плакат с изображением логотипа Конфедерации.
...
ent-PosterLegit50thAnniversaryVintageReprint = Винтажная перепечатка к 50-летнему юбилею
    .desc = Перепечатка плаката 2505 года, посвящённого 50-летию компании Nanoposters Manufacturing, дочерней компании Конфедерации.
ent-PosterLegitFruitBowl = Миска с фруктами
    .desc = Просто, но впечатляюще.
ent-PosterLegitPDAAd = Реклама КПК
    .desc = Плакат, рекламирующий новейшие КПК от поставщиков Конфедерации.
ent-PosterLegitEnlist = Вступай!
    .desc = Запишитесь в резерв эскадрона смерти Конфедерации сегодня!
...
ent-PosterLegitNoERP = Скажи "ДА" ЕРП!
    .desc = Этот плакат напоминает экипажу, что эротика и порнография разрешены на станциях "Конфедерации".
...
ent-PosterLegitThereIsNoGasGiant = Газового гиганта не существует
    .desc = Конфедерация распространила плакаты, подобные этому, по всем станциям, напоминая, что слухи о газовом гиганте недостоверны.
...
ent-PosterLegitVacation = Корпоративные привилегии Конфедерации: Отпуск
...
ent-PosterLegitRenault = Плакат с Алисой
    .desc = Йап.
ent-PosterLegitNTTGC = Тактическая карточная игра Конфедерации
    .desc = Реклама новой ТКИ от Конфедерации: ПОКУПАЙТЕ БОЛЬШЕ КАРТОЧЕК.
