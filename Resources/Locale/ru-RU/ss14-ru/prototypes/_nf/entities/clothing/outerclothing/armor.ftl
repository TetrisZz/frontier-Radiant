...
ent-ClothingOuterArmorCentcommCarapace = панцирь ЦК
    .desc = Бронированный нагрудник, обеспечивающий защиту и при этом сохраняющий максимальную подвижность и гибкость. Выдаётся только сотрудникам и агентам Центральных служб.
ent-ClothingOuterVestWebElite = элитный сетчатый жилет
    .desc = Синтетический бронежилет. В этом жилете добавлены лямки и термостойкие волокна.