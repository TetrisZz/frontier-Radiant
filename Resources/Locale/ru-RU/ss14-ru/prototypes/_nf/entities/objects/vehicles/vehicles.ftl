...
ent-NFVehicleHoverbikeNfsd = ховербайк ДВБК.
...
ent-NFVehicleSkeletonMotorcycle = скелетонский мотоцикл
    .desc = Bad to the Bone.
ent-VehicleHoverchair = ховер-кресло
    .desc = Роскошное кресло на воздушной подушке, откиньтесь назад и расслабьтесь.
