...
ent-ComputerShipyardSecurity = консоль приёма в ОСК
...
ent-ComputerShipyardNfsd = консоль верфи ОСК
    .desc = Здесь вы можете приобрести патрульные шаттлы ОСК, оснащенные новейшими технологиями и готовые к самым сложным заданиям. Поддержите закон и порядок среди звезд, используя надежные и мощные шаттлы, созданные для настоящих героев.
