...
ent-SignNfsd = знак ДВБ
    .desc = Знак, обозначающий территорию ДВБ
ent-SignNfsdArmoury = знак оружейной
    .desc = Знак, указывающий на то, что за ним находится оружейный склад ДВБ
ent-SignBath = знак ванной комнаты
    .desc = Знак, обозначающий территорию ванной комнаты
ent-SignNfsdBrief = знак комнаты бриффинга
    .desc = Знак, обозначающий территорию комнаты для брифинга
ent-SignNfsdBrig = знак брига
    .desc = Знак, обозначающий территорию брига
ent-NFSignBus = знак остановки
    .desc = Знак,указывающий на то, что машрутка причаливает неподалёку.
ent-SignNfsdDetective = знак детектива
    .desc = Знак, обозначающий территорию комнаты детектива.
