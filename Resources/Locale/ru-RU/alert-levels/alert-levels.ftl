...
# alert-level-gamma-instructions = Гражданский персонал обязан немедленно обратиться к главам отделов для получения указаний к эвакуации. Конфедерация заверяет вас - опасность скоро будет нейтрализована.
alert-level-gamma-announcement = Центральное командование объявило в секторе уровень угрозы "Гамма". Сотрудники ОСК должны быть в состоянии полной боевой готовности, а экипажи должны по возможности избегать любых зон конфликтов.
...
# alert-level-epsilon-announcement = Центральное командование объявило на станции уровень угрозы "Эпсилон". Все контракты расторгнуты. Спасибо, что выбрали Конфедерацию.
