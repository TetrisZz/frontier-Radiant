gun-examine-nf-recoil = - [color={$color}]Увеличение разброса[/color]: [color=lightblue]{NATURALFIXED($value, 1)}°[/color] после выстрела
gun-examine-nf-stability = - [color={$color}]Восстановление точности[/color]: [color=lightblue]{NATURALFIXED($value, 1)}°[/color] в секунду
