pirate-bounty-console-menu-title = Консоль наград
...
pirate-bounty-console-reward-label = Награда: [color=limegreen]{ $reward } Валюта ЧР[/color]
pirate-bounty-console-manifest-label = Список: [color=orange]{ $item }[/color]
pirate-bounty-console-manifest-entry =    { $amount ->
        [1] { $item }
       *[other] { $item } x{ $amount }
    }
pirate-bounty-console-manifest-reward = Награда: { $reward } Валюты ЧР
pirate-bounty-console-description-label = [color=gray]{ $description }[/color]
pirate-bounty-console-id-label = { $id }
pirate-bounty-console-flavor-left = Вперёд, на добычу, морские волки! Долой Конфедератов!
pirate-bounty-console-flavor-right = v0.0.1a
pirate-bounty-chest-name = сундук сепаратисткой награды ({ $id })
pirate-bounty-chest-description-start = На сундуке выгравированы следующие слова:
pirate-bounty-manifest-name = напоминание о награде ({ $id })
pirate-bounty-manifest-header = [font size=14][bold]Запрос на награду[/bold] ({ $id })[/font]
