...
# Radiant Sector
ui-options-jukebox-music = Jukebox and boombox music
...
ui-options-function-open-interaction-menu = Open interaction panel
ui-options-function-open-language-menu = Open speech language selector
