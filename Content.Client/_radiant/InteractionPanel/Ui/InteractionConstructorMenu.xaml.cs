...
namespace Content.Client.Interaction.Panel.Ui
{
    public sealed partial class InteractionConstructorMenu : DefaultWindow
    {
        ...
        private void InitializedItems()
        {
            ...
            SpeciesButton.AddItem(Loc.GetString("interaction-constructor-demon"), (int)Species.DemonSpecies);
            ...
            BlackListButton.AddItem(Loc.GetString("interaction-constructor-demon"), (int)Species.DemonSpecies);
            ...
            TargetSpeciesButton.AddItem(Loc.GetString("interaction-constructor-demon"), (int)Species.DemonSpecies);
        ...
        private InteractionPrototype? PrepareInteractionPrototype()
        {
            ...
            var spritePath = string.IsNullOrWhiteSpace(SpriteLine.Text)
                ? "/Textures/_radiant/Interface/InteractionPanel/heart.png"
                : SpriteLine.Text;
        ...
        {
            var pathRegex = new Regex(@"^(/Audio/Voice/|/Audio/Effects/|/Audio/_radiant/Voice/).+\.ogg$", RegexOptions.Compiled);
