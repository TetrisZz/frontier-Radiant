...
namespace Content.Client.Interaction.Panel.Ui
{
    ...
    public sealed partial class InteractionPanelMenu : DefaultWindow
    {
        ...
        private void OnInteractionPressed(string interactionId)
        {
            ...
            _entityNetworkManager.SendSystemNetworkMessage(new InteractionPressedEvent(userEntity.Value, interactionId, _entManager.GetNetEntity(target), null, hideFromOthers, hint));
        }
        ...
        private void OnInteractionPressed(string interactionId, InteractionPrototype prototype)
        {
            ...
            _entityNetworkManager.SendSystemNetworkMessage(new InteractionPressedEvent(userEntity.Value, interactionId, _entManager.GetNetEntity(target), prototype, hideFromOthers, hint));
        }
