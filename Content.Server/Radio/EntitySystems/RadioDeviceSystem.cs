...
public sealed class RadioDeviceSystem : EntitySystem
{
    ...
    private void OnListen(EntityUid uid, RadioMicrophoneComponent component, ListenEvent args)
    {
        ...
        if (_recentlySent.Add((args.Message, args.Source, channel)))
            _radio.SendRadioMessage(args.Source, args.Message, channel, uid, /*Nuclear-14-start*/ frequency: component.Frequency, /*Nuclear-14-end*/ language: args.Language); // Radiant Sector: retain language for portable radios.
    }
    ...
    private void OnReceiveRadio(EntityUid uid, RadioSpeakerComponent component, ref RadioReceiveEvent args)
    {
        ...
        // Radiant Sector: a portable speaker must preserve the original language too. Routing this
        // through ordinary speech loses it and makes unknown native speech readable nearby.
        _chat.SendRadioRelayInVoiceRange(uid, args.Message, component.OutputChatType, name, args.Language);
    }
